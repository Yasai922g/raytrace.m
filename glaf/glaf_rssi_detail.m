...
glaph_file_name=strcat('match_detail_',ant_name,'_Beam0_',az_angles0,'_Beam1_',az_angles1,'_p0_',p0,'_p1_',p1,'.pdf');
...
plot(data_1(178:224,2),data_1(178:224,3),'LineWidth',2,'Color',[0 0 1]);
xlim([1.1 1.3875]);
...
hold on
plot(data_2(178:224,2),data_2(178:224,3),'LineWidth',2,'Color',[1 0 0]);
