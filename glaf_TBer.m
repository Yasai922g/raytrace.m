...
glaph_file_name=strcat('TBER_',ant_name,'_Beam0_',az_angles0,'_Beam1_',az_angles1,'_pv0_',pv0,'_pv1_',pv1,'_',count_name,'.pdf');
...
semilogy(time_x,data,'LineWidth',2,'Color',[0 0 1]);
xlim([0 4.5]);
%ylim([10.^-10 10.^0]);
ylim([10.^-4 10.^0])
